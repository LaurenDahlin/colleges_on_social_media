...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{twitter\_username\_etl\_v1}
...
\makeatother
    ...
    \hypertarget{twitter-username-etl}{%
\section{Twitter Username ETL}\label{twitter-username-etl}}
...
\subsubsection{Search again for universities with
...
\end{Verbatim}
    ...
    Search again as in scrape\_ihe\_handles
...
\end{Verbatim}
    ...
    \hypertarget{manual-fix-for-schools-not-found-in-re-google}{%
\subsubsection{Manual fix for schools not found in
re-google}\label{manual-fix-for-schools-not-found-in-re-google}}
...
\end{Verbatim}
    ...
    \hypertarget{search-for-twitter-pages-of-schools-where-twitter-not-listed-on-main-page}{%
\subsubsection{Search for twitter pages of schools where Twitter not
listed on main
page}\label{search-for-twitter-pages-of-schools-where-twitter-not-listed-on-main-page}}
...
\subsubsection{Combine original csv with new results from updated google
search and twitter
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Append new data}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-13-e331606e92ae> in <module>()
          1 \# Append new data
          2 updated\_urls = updated\_urls.append(re\_google\_df)
    ----> 3 updated\_urls = updated\_urls.append(find\_twitter)
    

        NameError: name 'find\_twitter' is not defined
...
\subsubsection{Google search for missing admissions
...
\end{Verbatim}
    ...
    \hypertarget{review-likely-admissions-twitter-pages}{%
\subsubsection{Review likely admissions Twitter
pages}\label{review-likely-admissions-twitter-pages}}
...
\end{Verbatim}
    ...
    \hypertarget{replacements-from-manual-review}{%
\subsubsection{Replacements from manual
review}\label{replacements-from-manual-review}}
...
\end{Verbatim}
    ...
    \hypertarget{extract-twitter-names}{%
\subsubsection{Extract Twitter names}\label{extract-twitter-names}}
